...
function App() {
    ...
    return (_jsxs(Container, { children: [_jsx(Header, { phoneParams: phoneParams }, void 0),
            ...
            _jsxs(Paragraph, { children: [_jsx("h2", __assign({ style: { textAlign: 'left' } }, { children: "About" }), void 0),
                    ...
                    _jsx("p", __assign({ style: { fontWeight: 600 } }, { children: "Home button and volume button functionalities are WIP but in the meantime use the power button to toggle lockscreen!" }), void 0)] }, void 0),
